sap.ui.define([
    ...
    var Controller = Controller.extend("com.contacts.controller.login", {});
    ...
    ControllerProto.onPageEnter = function (oEvent) {
        if (this.getOwnerComponent().FirebaseUserManager.isLoggedIn()) {
            this.getOwnerComponent().toContactsList();
        }
    ...
    ControllerProto.onLoginButtonPress = function () {
        ...
        if (this.isEmailValid(sEmail).result && this.isValidPassword(sPassword).result) {
            ...
            this.getOwnerComponent().FirebaseUserManager.login(
                sEmail,
                sPassword,
    ...
    ControllerProto.onRegistrationButtonPress = function () {
        ...
        if (this.isEmailValid(sEmail).result && this.isValidPassword(sPassword).result) {
            this.m_oNavContainer.setBusy(true);
            this.getOwnerComponent().FirebaseUserManager.register(
                sEmail,
                sPassword,
                this.onLoginSuccess.bind(this),
    ...
    ControllerProto.onResetEmailButtonPress = function () {
        ...
        if (this.isEmailValid(sEmail).result) {
            ...
            this.getOwnerComponent().FirebaseUserManager.sendPasswordResetEmail({
